...
//数据流 web/app->ngix->SpringBoot->Mysql->FlinkApp->Kafka(ods)->FlinkApp->Kafka(dwd)/Phienix(dim)
//程序               mockDb->Mysql->FlinkCDC->Kafka(ZK)->BaseDBApp->Kafka/Phienix(hbase,zk,hdfs)
